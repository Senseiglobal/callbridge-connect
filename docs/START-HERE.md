...
## 1. Open your hosted demo — completed

Your public app is [CallBridge Connect](https://callbridge-connect.onrender.com/). It was deployed and tested on Render's Free plan on September 12, 2026. No paid resources or CALL-E keys were added.

1. Open the public app. If it has been idle, allow about a minute for it to wake.
2. Choose **New check-in**, then **Create sample check-in**, then **Preview callback**. These are fictional examples, not real calls.
